...
class Bug:
    ...
    def move(self, environment, trees, other_bugs, pesticides):
        ...
        current_temp = environment.current_temperature
        sensor_positions = environment.positions
        for idx in range(len(current_temp[0])):
            sensor_pos = sensor_positions[idx]
            temp = current_temp[0][idx] # Sensor temperature
